...
class Curl {
	...
	# Variables qui empechent le d�passement m�moire
	public $limit=0;	
	...
	public function request($method, $url, $vars = array()) {
		...
		/*On supprime ce qui suit le # car c'est une ancre pour le navigateur et avec on consi�re la validation fausse alors qu'elle est bonne
		 *On remplace les espaces par %20 pour la m�me raison
		 */
